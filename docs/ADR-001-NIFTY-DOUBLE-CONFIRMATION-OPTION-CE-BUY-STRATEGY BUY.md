ADR # ADR-001: NIFTY 50 Double Confirmation Buy Strategy
...
| 3 | MACD Bearish Momentum | Every 5 seconds | SELL |

### Sell Logic (2-minute timeframe) - Based on CE Option Price
```python
# Exit Trigger 1: EMA Low Falling (using CE Option price)
ema_low_falling = (
...
exit_trigger_1 = ema_low_falling AND ce_price_below_ema_low

# Exit Trigger 2: Strong Bearish (using CE Option price)
strong_bearish = (
...
# Exit Trigger 3: MACD Bearish Momentum (using CE Option price)
macd_bearish = macd < macd_signal       # MACD below Signal line

exit_trigger_3 = macd_bearish

# Exit if ANY trigger is TRUE
is_sell = exit_trigger_1 OR exit_trigger_2 OR exit_trigger_3
```
...
| 1.1 | Feb 2026 | Team | Added Exit Trigger 3: MACD Bearish Momentum (MACD < Signal line) |
